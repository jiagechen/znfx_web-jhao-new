...
export const constantRoutes = [
  ...
  },
  {
    ...
    children: [
      ...
      {
        path: 'trackTargetAviation',
        name: '民航轨迹数据存储表',
        component: () => import('@/views/dataManage/trackTargetAviation/index'),
        meta: { title: '民航轨迹数据存储表', icon: '' }
      },
      {
        path: 'trackTargetShip',
        name: '页面民船轨迹目标数据',
        component: () => import('@/views/dataManage/trackTargetShip/index'),
        meta: { title: '页面民船轨迹目标数据', icon: '' }
      }
      // {
      //   path: 'centreTrackHandle',
      //   name: '中心航线提取',
      //   component: () => import('@/views/dataManage/centreTrackHandle/index'),
      //   meta: { title: '中心航线提取', icon: '' }
      // },
    ]
  },
  {
